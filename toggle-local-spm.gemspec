...
Gem::Specification.new do |spec|
  ...
  # Published via RubyGems.org Trusted Publishing only (see .github/workflows/release.yml) —
  # require MFA for any other push path (e.g. a manual `gem push` from a maintainer's machine).
